desc = "Construct a dataset from raw data and save it to a directory. "
...
if __name__ == '__main__':
    ...
    from domain_expansion.dataset import build_converter
    ...
    parser.add_argument(
        "--dataset_name", "-n", default="terasim", help="Dataset name, will be used to generate scenario files"
    )
    parser.add_argument("--version", "-v", default='v1.0', help="version")
    ...
    get_scenarios_func, preprocess_func, convert_scenario_func = build_converter(dataset_name)
    ...
    write_to_directory(
        convert_func=convert_scenario_func,
        scenarios=files,
